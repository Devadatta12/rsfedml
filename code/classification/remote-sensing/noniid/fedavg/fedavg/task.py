...
def load_data(partition_id, num_partitions):
    ...
    training_path = "../../../../../data/fedarated_dataset/non_iid/train/partition_"+str(partition_id)
    testing_path = "../../../../../data/fedarated_dataset/non_iid/test/partition_"+str(partition_id)
